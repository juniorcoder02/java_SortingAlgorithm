public class BubbleSort {
     ...
     * 2. During each pass, compare adjacent elements (from the beginning of the
     * array to the end of the unsorted part).
     * 3. If the current element is greater than the next element, swap them to move
     * the larger element towards the end.
     * 4. Repeat step 2 for each pair of adjacent elements in the array, reducing
     * the number of comparisons with each pass.
     * 5. If no swaps occur during a pass, the array is already sorted, and you can
     * stop early.
